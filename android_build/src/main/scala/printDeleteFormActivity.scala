...
class DeleteFormActivity(objectName: String, fields: List[String], primaryKey: Option[String], basedir: String, url: String ) extends scalaMVCFile(objectName, fields, primaryKey, basedir, url)   {

	def print() = {
		val fileName = objectName.capitalize+"DeleteFormActivity.java"
...
//		write(writer,"import com.example.android.common.logger.Log;")
		...
		write(writer,"import org.apache.http.client.methods.HttpDelete;")
		...
		write(writer,"public class "+capitalizedObjectName+"DeleteFormActivity extends Activity {")
		...
		write(writer,tab+tab+"setContentView(R.layout."+objectName+"deleteform);")
		...
		write(writer,tab+tab+tab+"View rootView = inflater.inflate(R.layout."+objectName+"deleteform, container, false);")
		write(writer,tab+tab+tab+"return rootView;")
		write(writer,tab+tab+"}")
		write(writer,tab+"}")
		write(writer,"")
		write(writer,tab+"")
		write(writer,tab+tab+"public void sendMessage(View view) {")
		write(writer,tab+tab+"TextView tv = (TextView) findViewById(R.id."+primaryKey.get+");")
		write(writer,tab+tab+"String "+primaryKey.get+" = tv.getText().toString();")
		write(writer,tab+tab+"new UploadTask().execute(\""+url+objectName+"/\"+"+primaryKey.get+");")
		...
		write(writer,tab+tab+tab+tab+tab+"HttpDelete httpDelete = new HttpDelete(url.toString());")
		write(writer,tab+tab+tab+tab+tab+"HttpResponse httpResponse = httpClient.execute(httpDelete);")
