...
trait scalaMVC  {
	...
	def getLookupType(dataType: String): String =  {
		var scalaDataType = ""
		if ( dataType.toLowerCase.substring(0,3) == "num" ) {
			if ( dataType.contains(",") )
				scalaDataType = "Double"
			else
				scalaDataType = "Int"
		} else
			scalaDataType = lookupType(dataType.substring(0,3))
		
		scalaDataType
	
	}

	private def lookupType(dataType: String):String = dataType.toLowerCase match {
		case "var" => "String"
		case "tex" => "String"
		case "cha" => "String"
		case "nch" => "String"
	...
	def getLookupControllerType(dataType: String): String =  {
		var scalaDataType = ""
		if ( dataType.toLowerCase.substring(0,3) == "num" ) {
			if ( dataType.contains(",") )
				scalaDataType = "Double"
			...
			scalaDataType = lookupControllerType(dataType.substring(0,3))
	...
	private def lookupControllerType(dataType: String):String = dataType.toLowerCase match {
		case "var" => "String"
		case "tex" => "String"
		case "cha" => "String"
		case "nch" => "String"
